...
public class ApplicationConfig : SettingsBase<ApplicationConfig>
{
	...
	public int NameParserAutoIncrementNumber;
	...
	public bool CheckPreReleaseUpdates;
	...
	public ThumbnailTitleLocation ThumbnailTitleLocation;

	public Size ThumbnailSize = new Size(200, 150);

	public ThumbnailViewClickAction ThumbnailClickAction;

	public bool ShowColumns = true;

	public ImagePreviewVisibility ImagePreview = ImagePreviewVisibility.Automatic;

	public ImagePreviewLocation ImagePreviewLocation;
	...
	public bool UseSecondaryUploaders;
	...
	public decimal AutoCaptureRepeatTime = 60m;
	...
	public bool ActionsToolbarRunAtStartup;

	public Point ActionsToolbarPosition = Point.Empty;

	public bool ActionsToolbarLockPosition;
	...
	[DefaultValue(true)]
	[Description("Automatically check updates.")]
	public bool AutoCheckUpdate { get; set; }

	[Category("Application")]
	[DefaultValue(false)]
	[Description("Calculate and show file sizes in binary units (KiB, MiB etc.)")]
	public bool BinaryUnits { get; set; }

	[Category("Application")]
	[DefaultValue(false)]
	[Description("Show most recent task first in main window.")]
	public bool ShowMostRecentTaskFirst { get; set; }

	[Category("Application")]
	[DefaultValue(false)]
	[Description("Show only customized tasks in main window workflows.")]
	public bool WorkflowsOnlyShowEdited { get; set; }

	[Category("Application")]
	[DefaultValue(false)]
	[Description("Automatically expand capture menu when you open the tray menu.")]
	public bool TrayAutoExpandCaptureMenu { get; set; }

	[Category("Application")]
	[DefaultValue(true)]
	[Description("Show tips and hotkeys in main window when task list is empty.")]
	public bool ShowMainWindowTip { get; set; }

	[Category("Application")]
	[DefaultValue("")]
	[Description("URLs will open using this path instead of default browser. Example path: chrome.exe")]
	...
	[Category("Hotkey")]
	[DefaultValue(false)]
	[Description("Disables hotkeys.")]
	public bool DisableHotkeys { get; set; }

	[Category("Hotkey")]
	[DefaultValue(false)]
	[Description("If active window is fullscreen then hotkeys won't be executed.")]
	public bool DisableHotkeysOnFullscreen { get; set; }

	[Category("Hotkey")]
	[DefaultValue(500)]
	[Description("If you hold hotkeys then it will only trigger every this milliseconds.")]
	...
	[Category("Clipboard")]
	[DefaultValue(true)]
	[Description("Show clipboard content viewer when using clipboard upload in main window.")]
	public bool ShowClipboardContentViewer { get; set; }

	[Category("Clipboard")]
	[DefaultValue(true)]
	[Description("Because default .NET image copying not supports alpha channel, background of image will be black. This option will fill background white.")]
	public bool DefaultClipboardCopyImageFillBackground { get; set; }

	[Category("Clipboard")]
	[DefaultValue(false)]
	[Description("Default .NET method can't copy image with alpha channel to clipboard. When this setting is true, ShareX copies \"PNG\" and 32 bit \"DIB\" to clipboard in order to retain image transparency.")]
	public bool UseAlternativeClipboardCopyImage { get; set; }

	[Category("Clipboard")]
	[DefaultValue(false)]
	[Description("Default .NET method can't get image with alpha channel from clipboard. When this setting is true, ShareX checks if clipboard contains \"PNG\" or 32 bit \"DIB\" in order to retain image transparency.")]
	public bool UseAlternativeClipboardGetImage { get; set; }

	[Category("Image")]
	[DefaultValue(true)]
	[Description("If JPEG exif contains orientation data then rotate image accordingly.")]
	public bool RotateImageByExifOrientationData { get; set; }

	[Category("Image")]
	[DefaultValue(false)]
	[Description("Strip color space information chunks from PNG image.")]
	public bool PNGStripColorSpaceInformation { get; set; }

	[Category("Upload")]
	[DefaultValue(false)]
	[Description("Can be used to disable uploading application wide.")]
	public bool DisableUpload { get; set; }

	[Category("Upload")]
	[DefaultValue(false)]
	[Description("Accept invalid SSL certificates when uploading.")]
	public bool AcceptInvalidSSLCertificates { get; set; }

	[Category("Upload")]
	[DefaultValue(true)]
	[Description("Ignore emojis while URL encoding upload results.")]
	public bool URLEncodeIgnoreEmoji { get; set; }

	[Category("Upload")]
	[DefaultValue(true)]
	[Description("Show first time upload warning.")]
	public bool ShowUploadWarning { get; set; }

	[Category("Upload")]
	[DefaultValue(true)]
	[Description("Show more than 10 files upload warning.")]
	public bool ShowMultiUploadWarning { get; set; }

	[Category("Upload")]
	[DefaultValue(100)]
	[Description("Large file size defined in MB. ShareX will warn before uploading large files. 0 disables this feature.")]
	public int ShowLargeFileSizeWarning { get; set; }

	[Category("Paths")]
	[Description("Custom uploaders configuration path. If you have already configured this setting in another device and you are attempting to use the same location, then backup the file before configuring this setting and restore after exiting ShareX.")]
	[Editor(typeof(DirectoryNameEditor), typeof(UITypeEditor))]
	public string CustomUploadersConfigPath { get; set; }

	[Category("Paths")]
	[Description("Custom hotkeys configuration path. If you have already configured this setting in another device and you are attempting to use the same location, then backup the file before configuring this setting and restore after exiting ShareX.")]
	[Editor(typeof(DirectoryNameEditor), typeof(UITypeEditor))]
	public string CustomHotkeysConfigPath { get; set; }

	[Category("Paths")]
	[Description("Custom screenshot path (secondary location). If custom screenshot path is temporarily unavailable (e.g. network share), ShareX will use this location (recommended to be a local path).")]
	[Editor(typeof(DirectoryNameEditor), typeof(UITypeEditor))]
	public string CustomScreenshotsPath2 { get; set; }

	[Category("Drag and drop window")]
	[DefaultValue(150)]
	[Description("Size of drop window.")]
	public int DropSize { get; set; }

	[Category("Drag and drop window")]
	[DefaultValue(5)]
	[Description("Position offset of drop window.")]
	public int DropOffset { get; set; }

	[Category("Drag and drop window")]
	[DefaultValue(ContentAlignment.BottomRight)]
	[Description("Where drop window will open.")]
	public ContentAlignment DropAlignment { get; set; }

	[Category("Drag and drop window")]
	[DefaultValue(100)]
	[Description("Opacity of drop window.")]
	public int DropOpacity { get; set; }

	[Category("Drag and drop window")]
	[DefaultValue(255)]
	[Description("When you drag file to drop window then opacity will change to this.")]
